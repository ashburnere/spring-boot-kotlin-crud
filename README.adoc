...
To build and run the app use use (for Gradle) ```./gradlew bootRun```
...
Swagger-UI is visible at `http://localhost:8080/swagger-ui-custom.html` and H2-Console at `http://localhost:8080/h2-console`.
